	...
	return (
		<>
			...
			<div className='flex justify-center'>
				...
				<div className="w-full pb-10 rounded-b-[0px] mobile-lg:px-4 tablet-sm:w-[400px] absolute bottom-0 laptop-lg:relative rounded-2xl bg-blink-black-2 mt-2 px-2 text-white">
								...
								return (
									...
									<Link key={index} onClick={()=>setfollowersVisibility(false)} to={`/profile/${user._id}`}>
										...
										<li className="flex justify-start" key={index}>
											...
											<div className="w-[66%] px-4 py-4 font-semibold">
											...
											<div className="flex item-center">
												{user._id !== loggedUserId && <button onClick={(e)=>handleFollow(e,listItem.isFollowing,user._id)} className="w-[90px] py-[2px] my-auto bg-blink-gradient-1 px-2 text-sm rounded">
